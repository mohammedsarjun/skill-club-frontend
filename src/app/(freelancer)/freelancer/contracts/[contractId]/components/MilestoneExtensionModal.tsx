...
interface MilestoneExtensionModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export default function MilestoneExtensionModal({
  isOpen,
  onClose,
  milestoneDeadline,
  onSubmit,
}: MilestoneExtensionModalProps) {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between p-6 border-b">
          <h2 className="text-2xl font-bold text-gray-800">Request Milestone Extension</h2>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-6">
          <div>
            <p className="text-gray-600 mb-2">
              Current deadline: {new Date(milestoneDeadline).toLocaleDateString()}
            </p>
          ...
          <div>
            ...
            <BeautifulCalendar
              ...
              minDate={new Date(milestoneDeadline)}
            />
            {selectedDate && (
