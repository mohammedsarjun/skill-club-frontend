        ...
        {meetings.map((meeting) => (
          ...
          >
            ...
            <div className="flex items-center gap-2 text-sm text-red-700 bg-red-50 px-3 py-2 rounded-md">
              ...
              <span>
                {meeting.isProposedByFreelancer
                  ? 'This meeting request expired without a response from the client'
                  : 'This meeting request from the client expired without your response'}
              </span>
            </div>
          </div>
        ))}
