  ...
  return (
    <div className="space-y-4">
      <div className="mb-4">
        ...
        <p className="text-sm text-gray-600 mt-1">Review meeting reschedule requests from freelancers</p>
      </div>

      <div className="grid gap-4">
        {meetings.map((meeting) => {
          const isRequestedByFreelancer = meeting.rescheduleRequestedBy === 'freelancer';
          ...
          return (
            ...
            >
              ...
              {isRequestedByFreelancer && meeting.status === 'rescheduled_requested' && (
              ...
              {!isRequestedByFreelancer && (
                <div className="flex items-center gap-2 text-sm text-amber-700 bg-amber-50 px-3 py-2 rounded-md">
                  <Clock className="w-4 h-4" />
                  <span>Waiting for freelancer to respond to your reschedule request</span>
                </div>
              )}
            </div>
          );
