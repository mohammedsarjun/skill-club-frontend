  ...
  return (
    <div className="space-y-4">
      <div className="mb-4">
        ...
        <p className="text-sm text-gray-600 mt-1">Review your past meetings with freelancers</p>
      </div>
          ...
          >
            ...
            {meeting.attendance && (
              <div className="grid grid-cols-2 gap-4 mb-4">
                ...
                <div className="bg-purple-50 rounded-md p-3">
                  <p className="text-xs font-medium text-gray-700 mb-1">Freelancer Attendance</p>
                  <p className="text-sm text-gray-900">
            ...
            {meeting.notes?.clientNotes && (
              <div className="bg-indigo-50 rounded-md p-3">
                ...
                <p className="text-sm text-gray-600">{meeting.notes.clientNotes}</p>
              </div>
            )}
          </div>
        ))}
