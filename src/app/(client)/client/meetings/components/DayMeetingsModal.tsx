          ...
          {dayMeetings.length === 0 ? (
            ...
            <div className="space-y-4">
              {dayMeetings.map((meeting) => {
                const freelancer = meeting.freelancer;
                const displayName = freelancer
                  ? `${freelancer.firstName || ''} ${freelancer.lastName || ''}`.trim()
                  : 'Unknown';
                const avatarUrl = freelancer?.profilePicture || `https://ui-avatars.com/api/?name=${encodeURIComponent(displayName)}&background=3b82f6&color=fff`;
                ...
                return (
                  ...
                  >
                    ...
                    {meeting.status === 'proposed' && meeting.isProposedByClient === false && (
