  ...
  return (
    <div className="space-y-4">
      <div className="mb-4">
        ...
        <p className="text-sm text-gray-600 mt-1">Track the status of meeting requests you&apos;ve proposed to freelancers</p>
      </div>
          ...
          >
            ...
            {meeting.status === 'proposed' && (
              <div className="flex items-center gap-2 text-sm text-amber-700 bg-amber-50 px-3 py-2 rounded-md">
                ...
                <span>Waiting for freelancer to accept your meeting request</span>
              </div>
            )}

            {meeting.status === 'rejected' && (
              <div className="text-sm text-red-600 bg-red-50 px-3 py-2 rounded-md">
                The freelancer has declined this meeting request
              </div>
            )}
          </div>
        ))}
