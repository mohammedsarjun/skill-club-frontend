...
const ReceivedRequests: React.FC<ReceivedRequestsProps> = ({
  ...
  if (meetings.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-600">You don&apos;t have any pending meeting requests from freelancers.</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-4">
      <div className="mb-4">
        <h3 className="text-lg font-semibold text-gray-900">Meeting Requests from Freelancers</h3>
        <p className="text-sm text-gray-600 mt-1">Review and respond to meeting requests sent by your freelancers</p>
      </div>
